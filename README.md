...
Bubble sort has a time complexity of O($n^2$), hence multiplying the length of the input list by 10 results in the algorithm taking $(10n)^2/n^2$ = 100 times longer, which in line with the timings from the speed tests.
