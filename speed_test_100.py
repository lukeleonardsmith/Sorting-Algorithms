...
def speed_test_100():
  ...
  bubble_sort_time=timeit.timeit(lambda: bubble_sort(a), number=100)/100
  bubble_sort_finish_early_time=timeit.timeit(lambda: bubble_sort_finish_early(a), number=100)/100 
  quick_sort_time=timeit.timeit(lambda: quick_sort(a), number=100)/100
  quick_sort_fast_time=timeit.timeit(lambda: quick_sort_fast(a), number=100)/100
  merge_sort_time=timeit.timeit(lambda: merge_sort(a), number=100)/100
  insertion_sort_time=timeit.timeit(lambda: insertion_sort(a), number=100)/100
